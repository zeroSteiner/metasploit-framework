    ...
    begin
      ...
      when Net::LDAP::PDU::SearchRequest # search request
        if cli.authenticated
          ...
          encode_ldap_response(pdu.message_id, Net::LDAP::ResultCodeNoSuchObject, "", "No such object", 5)
        else
          encode_ldap_response(pdu.message_id, Net::LDAP::ResultCodeUnwillingToPerform, "", "I'm sorry Dave, I can't do that", 5)
        end
      else
        nil
      end
